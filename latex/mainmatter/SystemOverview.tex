...
\end{comment}
    ...
    \paragraph{Reading and Skeletonising the Map:}

    The skeleton planner generates a morphological skeleton. Internally, the planner fills the free-space contours, skeletonises the free-space region, extracts skeleton pixels,
