...
\begin{paracol}
    ...
    The main task of the robot can be broken down into sub-tasks which then fit into specific niches of the entire system architecture. \textbf{Motion planning}, \textbf{perception} and \textbf{navigation}. Figure \ref{tasks} showcases this idea.
    ...
    provided by the \href{https://github.com/MartijnWisse/mirte\_navigation}{MIRTE Navigation} ros2 package.
