...
\begin{paracol}
   ...
   The setup consists of a mobile manipulator (MIRTE Master) tasked with autonomously exploring an indoor laboratory environment, identifying and localizing objects, distinguishing between electronics and other objects and sorting these objects accordingly.
    ...
    \caption[]{Normalised confusion matrix: most classes are classified correctly, as indicated by the strong diagonal values. Some of objects were missed as background, a small amount of objects were misclassified, and some objects were recognised while they should not.}
    \label{fig_trainingdatasetplots}
    \end{figure}
