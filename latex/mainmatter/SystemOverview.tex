...
\begin{paracol}
    ...
    \begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/global_tree-2bf659e406234184b268bd363f526c70.png}
    \end{figure}
    \end{paracol}
    \newpage
    \begin{paracol}
    ...
    scope of this work, they are described with sufficient detail to
    enable understanding of their application within our framework. For in-depth technical details and formal derivations, the reader is referred to
    ...
    to 0 and occupied space to 1. It then detects the boundaries of the
    ...
    the map is first partitioned (decomposed) into smaller areas that can be
    ...
    \begin{paracol}
        {2}
    \includegraphics[width=0.95\linewidth]{figures/2d7b2cbc1b8dc1aa7aa5a49495009de2.png}
    ...
    \includegraphics[width=0.95\linewidth]{figures/4599d3c4df780082d726948f94d0cc2d.png}
