...
\begin{paracol}
   ...
   The setup consists of a mobile manipulator (MIRTE Master) tasked with autonomously exploring an indoor laboratory environment, identifying and localizing objects, distinguishing between electronics and other objects, and sorting these objects accordingly.
    ...
    Each defined navigator must update its internal map and as a result plan a path over this map. A function first takes the costmap and, given a threshold, sets the free space to 0 and occupied space to 1. It then detects the boundaries of the free space and saves these as contours. An example of this can be seen in Figure \ref{fig:costmap} below.
    ...
    visited. \newline The algorithm repeats this process until all leaf nodes have
