...
The majority of hardware used in this implementation of the MIRTE Master stems from the standardized components implemented by the MIRTE team, which is what this section aims to specify. {\textbackslash}
...
DC motor brackets{\textbackslash}
