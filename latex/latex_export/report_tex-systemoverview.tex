...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_bins-5a784ece62a5ee662b2c68b633300cb4.png}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/global_tree-7b860267dd9b16cffde466f8def72448.png}
\end{figure}