...
\textbf{Motion planning}, \textbf{perception} and \textbf{navigation}. Figure~\ref{fig-task_bins} showcases this idea.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_bins-fceaaa6999acf16e3b872aa4f23557ad.png}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/global_tree-44f2b71ddc42b18e4fdd0cfff960c968.png}
\end{figure}