...
\include{report_tex-introduction}

\include{report_tex-materials}

\include{report_tex-systemoverview}

\include{report_tex-navigation}

\include{report_tex-coverageplanners}

\include{report_tex-mechanical}

\include{report_tex-manipulation}

\include{report_tex-perception}

\include{report_tex-perception2d}

\include{report_tex-perception3d}

\include{report_tex-pointcloudprocessing}

\include{report_tex-methods}

\include{report_tex-results}

\include{report_tex-conclusion}

\include{report_tex-discussion}

\section{Appendix}

\include{report_tex-listofchanges}
