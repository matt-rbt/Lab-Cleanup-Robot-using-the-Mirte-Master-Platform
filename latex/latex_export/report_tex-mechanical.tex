...
The complete model can be explored by using the interactive 3D interface below (\href{https://matt-rbt.github.io/Lab-Cleanup-Robot-using-the-Mirte-Master-Platform/mechanical/}{Mechanical}).
...
<model -viewer
    src="https://matt -rbt.github.io/Lab -Cleanup -Robot -using -the -Mirte -Master -Platform/models/MM -final -compressed.glb"
    camera -controls
    auto -rotate
    exposure = 0.4
