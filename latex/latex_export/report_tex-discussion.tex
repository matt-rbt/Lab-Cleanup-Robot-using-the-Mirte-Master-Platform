...
When transfering the code base from the simulation environment to the real world many problems occured. Firstly, the code had to be adjusted: the `use\_sim\_time' had to be left unused and secondly: we found out that the sensors of the robot gave way less accurate and reliable feedback.
